...
DATABASES = {
    ...
    'vgw': {
    	...
    	'HOST': GetConfig('VGW_DB_HOST'),
        'NAME': GetConfig('VGW_DB_NAME'),
        'USER': GetConfig('VGW_DB_USER'),
        'PASSWORD': GetConfig('VGW_DB_PASSWORD'),
    },
}
...
MEDIA_ROOT = GetConfig("ROOT_DIR") + '/site/npg/templates/images/'
...
SECRET_KEY = 'q9uyp$_xqz2cwq=%&v&#eq2_rwkb6ww67jt25pm++!xgjclhj@'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    GetConfig("ROOT_DIR") + '/site/npg/templates', # Change this to your own directory.
