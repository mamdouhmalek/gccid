...
class NpMessages(models.Model):
	...
	ALL_OPERATOR_CHOICES = (
        ...
        (u'LSCO', u'LSCO - Lightspeed Communications W.L.L'),
        ...
        (u'RWAB', u'RWAB - Rawabi Telecommunications and Software Co. LTD'),
	...
	NEW_ROUTE_CHOICES = (
		...
		(u'b13', u'RWAB - Rawabi Telecommunications and Software Co. LTD'),
	...
	donor_id = models.CharField("Donor ID", max_length=8, choices=LIVE_OPERATOR_CHOICES, blank=True, null=True)
